...
import com.kylin.design_patterns.builder.SoupBuffet;
...
public class TestSoupFactoryMethod {
	...
	public static void main(String[] args) {
		...
		SoupFactoryMethod bostonSoupFactoryMethod = new BostonSoupFactoryMethod();
		...
		SoupFactoryMethod honoluluSoupFactoryMethod = new HonoluluSoupFactoryMethod();
